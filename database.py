...
async def db_signup(data: dict) -> dict:
    ...
    user = await collection_user.insert_one({"username": username, "email": email, "password": auth.generate_hashed_pw(password), "birthday": birthday, "avatar":avatar, "gender": gender, "agreement": agreement})
